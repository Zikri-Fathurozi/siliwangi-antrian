...
class RouteServiceProvider extends ServiceProvider
{
  ...
  public function map()
  {
    if (env("APP_WEBSERVICE")) {
      $this->mapChannelApiRoutes();
      $this->mapMigrateApiRoutes();
      $this->mapMobileApiRoutes();
    }

    if (env("APP_TICKET")) {
      $this->mapTicketApiRoutes();
    }
  ...
  protected function mapChannelApiRoutes()
  {
    Route::prefix("api/bpjs")
      ->namespace($this->namespace)
  ...
  protected function mapMigrateApiRoutes()
  {
  ...
  protected function mapTicketApiRoutes()
  {
    Route::prefix("api/ticket")
      ->namespace($this->namespace)
      ->middleware("ticket")
