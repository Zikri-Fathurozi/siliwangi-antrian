...
return [
  ...
  "after" => ":attribute Tidak Berlaku Mundur",
  "after_or_equal" =>
  ...
  "date_format" =>
    "Format :attribute Tidak Sesuai, Format Yang Benar adalah :format",
  ...
  "numeric" => "Format :attribute Tidak Sesuai",
  ...
  "custom" => [
    "kodepoli" => [
      "in" => "Poli Tidak Ditemukan",
    ],
    "tanggalantrian" => [
      "after" => ":attribute Tidak Berlaku",
    ],
    "tanggalperiksa" => [
      "before_or_equal" =>
        "Maksimal Booking H-" . config("antrian.online_booking.max_days"),
    ],
    "nik" => [
      "digits" => "Format :attribute Tidak Sesuai",
    ],
    "nomorkartu" => [
      "digits" => "Format :attribute Tidak Sesuai",
    ],
  ...
  "attributes" => [
    ...
    "nomorkartu_jkn" => "Nomor Kartu",
    "kodepoli" => "Kode Poli",
    "tanggalperiksa" => "Tanggal Periksa",
    "tanggalantrian" => "Tanggal Periksa",
    "nik" => "NIK",
    "nomorkk" => "Nomor KK",
    "nama" => "Nama",
    "alamat" => "Alamat",
    "tanggallahir" => "Tanggal Lahir",
    "kodeprop" => "Kode Propinsi",
    "namaprop" => "Nama Propinsi",
    "kodedati2" => "Kode Dati 2",
    "namadati2" => "Dati 2",
