                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card mb-0" style="background-color:#0f4110">
                      ...
                      >
                        <div
                          ...
                          style="color:#FFF176;font-size:5vh"
                        >
                          {{ nomor_daftar }}
                        </div>
                    ...
                    >
                      ...
                      >
                        <tr v-for="(s, index) in summary" :key="index">
                          <td>
                            <span style="font-size:4vh">{{ s.prefix }}</span>
                          </td>
                          <td
...
export default {
  ...
  methods: {
    get_summary() {
      axios
        .post("api/pendaftaran/summary")
        .then(response => (this.summary = response.data));
    },

    init_data() {
      axios
        .post("api/pendaftaran/nomor-current")
      ...
      this.ws.onmessage = function(e) {
        ...
        if (data.target == "display") {
          if (data.sub_target == "update_setting") {
            self.init_data();
          } else if (data.sub_target == "pendaftaran") {
